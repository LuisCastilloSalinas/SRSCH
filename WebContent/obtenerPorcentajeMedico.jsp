...
<body style="background-color: black">
  ...
  <span class="badge badge-inverse">Director</span>
  </div>
		<div class="col-md-12">
			
				<h2 class="text-center">Obtener Ocupación Médico</h2>
			
		</div>
	</div>
	<form action="ServletPorcMed" method="post">
		<div class="container">
			...
			<div class="row well">
				<div class="col-md-4 well">
					<ul class="nav nav-pills nav-stacked">
						<li><a href="obtenerPorcentajeBox.jsp">Obtener Porcentaje
								Ocupacion Box Médico</a></li>
						<li><a href="obtenerMedicoMasSolicitado.jsp">Obtener
								Médico Más Solicitado</a></li>
						<li><a href="obtenerPacienteUtilizaMasSistema.jsp">Obtener
								Paciente que utiliza más el sistema</a></li>
						<li><a href="obtenerPorcentajeMedico.jsp">Obtener
								porcentaje Ocupación Médico</a></li>
					</ul>
				...
				<div class="col-md-8 well">
					...
					<div class="row" style="margin-top: 2em;">
						...
						<div class="col-md-2">
						<button class="btn- btn-danger" type="reset" id="reset">Limpiar</button>
						</div>
