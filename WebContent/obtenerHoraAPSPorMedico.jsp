		...
		<div class="dropdown col-md-3">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
				<li role="presentation"><a role="menuitem" tabindex="-1"
					href="obtenerPorcentajeBox.jsp">Director</a></li>
				<li role="presentation" class="divider"></li>
				<li role="presentation"><a role="menuitem" tabindex="-1"
					href="reservarHoraAps.jsp">Paciente</a></li>
				<li role="presentation" class="divider"></li>
				<li role="presentation"><a role="menuitem" tabindex="-1"
		...
		<div class="row well">
			<div class="col-md-4 well">
				<ul class="nav nav-pills nav-stacked">
					<li><a href="obtenerHoraAPSPorMedico.jsp">Buscar hora
							médica APS por médico</a></li>
					<li><a href="obtenerHoraAPSPorRango.jsp">Buscar hora
							médica APS por rango</a></li>
			...
			<div class="col-md-8 well">
				...
				<div class="row">
					...
					<div>
						<input name="fecha1" type="text" class="datepicker" value=""
							id="dpd1" readonly="readonly" required="required"></input>
					</div>
				...
				<div class="row">
					...
					<div>
						<input name="fecha2" type="text" class="datepicker" value=""
							id="dpd2" readonly="readonly" required="required"></input>
					</div>
				...
				<div class="row" id="reporte" hidden="" style="margin-top: 3em;">
						<div class="col-md-5  col-md-offset-2">
							...
							<tr>
								<td>id</td><td>Hora </td> <td>Médico</td>
							</tr>
							</table>
						</div>
