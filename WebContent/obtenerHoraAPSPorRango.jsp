...
<body style="background-color:black;">
  ...
  <span class="badge badge-inverse">Paciente</span>
		...
		<div class="col-md-12">
				...
				<h2 class="text-center">Obtener hora APS por Rango</h2>
				...
				<div class="col-md-8 well">
					...
					<div class="row" style="margin-top: 2em;">
						<div class="col-md-2 col-md-offset-4">
							<input type="submit" value="Buscar" id="buscarR">
						</div>
						<div class="col-md-2">
					...
					<div class="row" id="reporte" hidden="" style="margin-top: 3em;">
						<div class="col-md-5  col-md-offset-2">
							<table class="tabla table-bordered table-responsive" border='4'>
							<tr>
								<td>id</td><td>Hora </td> <td>Médico</td><td>Reserva</td>
							</tr>
							</table>
						</div>
